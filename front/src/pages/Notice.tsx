...
function Notice() {
  return (
    <Container>
      <div style={{color:'black', fontWeight: 'bold', fontSize: '24px', marginBottom:'30px'}}>
      <div><CampaignOutlinedIcon
          sx={{ float: 'left', color: 'black', width: 50, height: 32, marginLeft: '-18px'}}
        >
        </CampaignOutlinedIcon> </div>
      ...
      <TimelineItemContainer>
        ...
        <TimelineItemContainer>
          <TimelineItem>
            ...
            <Contents style={{whiteSpace: "pre-wrap"}}>
            1. 전체 기능을 대상으로, API 테스팅 및 부하 테스팅이 진행되었습니다. {"\n"}
            2. 발행 이력 테이블의 View Mode, Edit Mode 관련 디버깅이 진행되었습니다. {"\n"}
            3. Notion, Tistory, Github 토큰의 암호화 및 복호화가 적용되었습니다. {"\n"}
        ...
        <TimelineItemContainer>
          <TimelineItem>
            ...
            <a href="https://chrome.google.com/webstore/detail/nogari-%EB%85%B8%EC%85%98%EC%97%90%EC%84%9C-%EA%B0%80%EB%8A%94-%EC%9D%B4%EC%95%BC%EA%B8%B0/hjdmhaniikfbncdhikfbgfkpchicegfp?hl=ko" target='_blank'>
        ...
        <TimelineItemContainer>
          <TimelineItem>
            ...
            2. Notion, Tistory, Github의 토큰 발급 상태를 확인하는 기능이 추가되었습니다. {"\n"}
        ...
        <TimelineItemContainer>
          <TimelineItem>
            ...
            <Contents style={{whiteSpace: "pre-wrap"}}>
            1. Tistory 발행 프로세스 진행시, 사용자의 요청 순서와 발행 순서가 일치하지 않는 문제가 수정되었습니다.  {"\n"}
        ...
        <TimelineItemContainer>
          <TimelineItem>
            ...
            <Contents style={{whiteSpace: "pre-wrap"}}>
            1. Notion To Tistory 발행 및 수정 프로세스에 멀티스레딩이 적용되었습니다. {"\n"}
        ...
        <TimelineItemContainer>
          <TimelineItem>
            ...
            <Contents style={{whiteSpace: "pre-wrap"}}>
            1. Notion 페이지에 업로드된 이미지를 Tistory에 순서대로 발행하는 기능이 구현되었습니다. {"\n"}
        ...
        <TimelineItemContainer>
          <TimelineItem>
            ...
            2. Tistory Access Token 및 Github Access Token 연동 기능이 구현되었습니다. {"\n"}
            </Contents>
          </TimelineItem>
        </TimelineItemContainer>
        ...
        <TimelineItemContainer>
          <TimelineItem>
            ...
            <Contents style={{whiteSpace: "pre-wrap"}}>
            1. Notion 페이지를 마크다운(.md)으로 변환하는 파싱 함수가 구현되었습니다. {"\n"}
